...
const EditProfile: FC<EditProfileProps> = ({ChangeBackground, ChangeAvatar, close, submitForm, reg, valuesApi}) => {
    return <div className={s.add_product_block}>
        ...
        <div className={s.container}>
            ...
            <SeachSelect values={countries.names()} api={valuesApi('country')}/>
            {/*<HeadField title={'Country'} values={reg('country')} />*/}
            {/*<SeachSelect values={countries.capitals()} onChange={setValue('city')}/>*/}
            {/*<HeadField title={'City'} values={reg('city')} />*/}
