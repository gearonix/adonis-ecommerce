...
exports.removeElement = exports.addIfNotExists = exports.sleep = exports.withLimit = exports.ifExist = exports.isNumber = exports.getResponse = exports.getRequest = exports.lastItemOf = exports.generateId = void 0;
...
exports.sleep = sleep;
const addIfNotExists = (array, element) => {
    if (!element) {
        return array;
    }
...
const removeElement = (array, element) => array.filter((item) => item !== element);
